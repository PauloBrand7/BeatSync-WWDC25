...
struct TrackSelectionView: View {
    ...
    let drumTracks = ["Soft Drum", "Acoustic Drum", "House Drum"]
    let bassTracks = ["Dubstep Bass", "Synth Bass", "Kick Bass", "Lo-Fi Bass"]
    let synthTracks = ["Crystals Synth", "Progressive Synth", "Bells Synth"]
